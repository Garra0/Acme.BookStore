...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 97502239-022a-48a9-9249-d23dd273edeb
```

> `97502239-022a-48a9-9249-d23dd273edeb` is the password of the certificate, you can change it to any password you want.
